...
movies = pickle.load(open('D:/research/movie-recommendation/movie_list.pkl','rb'))
similarity = pickle.load(open('D:/research/movie-recommendation/similarity.pkl','rb'))
